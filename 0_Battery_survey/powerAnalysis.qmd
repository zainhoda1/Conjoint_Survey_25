...
design_rand_output <-design_rand %>%
  ...
  mutate(image=paste0("Range_Degradation_", battery_range_year0, "_", battery_degradation*100,".png")) %>% 
...
ggsave(plot = Range_SoH_full_image, filename  = here::here("images","battery_choices_version1", "SoH_range_full_image.png"), width = 15, height = 12)
