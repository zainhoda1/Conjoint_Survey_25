...
car_lc_3c <- readRDS(here(
  ...
  "battery_analysis",
  "apollo",
  "rangeloss_car_lc_3c_1_model.rds"
))
...
car_lc_3c_apollo_inputs <- readRDS(here(
  ...
  "battery_analysis",
  "apollo",
  "car_lc_3c_apollo_inputs_rangeloss.rds"
))
...
car_lc_3c_apollo_probabilities <- readRDS(here(
  ...
  "battery_analysis",
  "apollo",
  "car_lc_3c_apollo_probabilities_rangeloss.rds"
))
...
suv_lc_3c <- readRDS(here(
  ...
  "battery_analysis",
  "apollo",
  "rangeloss_suv_lc_3c_1_model.rds"
))
suv_lc_3c_apollo_inputs <- readRDS(here(
  ...
  "battery_analysis",
  "apollo",
  "suv_lc_3c_apollo_inputs_rangeloss.rds"
))
...
car_suv_lc_3c <- readRDS(here(
  ...
  "battery_analysis",
  "apollo",
  "rangeloss_car_suv_lc_3c_1_model.rds"
  # "degradation_car_suv_lc_3c_1_model.rds"
))
...
car_suv_lc_3c_apollo_inputs <- readRDS(here(
  ...
  "battery_analysis",
  "apollo",
  "car_suv_lc_3c_apollo_inputs_rangeloss.rds"
  # "car_suv_lc_3c_apollo_inputs_degradation.rds"
))
...
car_suv_lc_3c_apollo_probabilities <- readRDS(here(
  ...
  "battery_analysis",
  "apollo",
  "car_suv_lc_3c_apollo_probabilities_rangeloss.rds"
  # "car_suv_lc_3c_apollo_probabilities_degradation.rds"
))
...
var_meta <- tribble(
  ...
  # "range_year0"                , "BEV Electric Range at Year 3 (per 100 miles)"   , "WTP (*1000 USD) for Vehicle Attributes" , "dollar" ,
  # "degradation"                , "Range loss in the next 5 years (per 100 miles)" , "WTP (*1000 USD) for Vehicle Attributes" , "dollar" ,
  # "range_year0"                , "BEV Electric Range at Year 0 (per 100 miles)" , "WTP (*1000 USD) for Vehicle Attributes" , "dollar" ,
  # "degradation"                , "Range loss after 8 years (per 100 miles)"     , "WTP (*1000 USD) for Vehicle Attributes" , "dollar" ,
  # "range_year0"                , "BEV Electric Range at Year 3 (per 100 miles)"     , "WTP (*1000 USD) for Vehicle Attributes" , "dollar" ,
  # "degradation"                , "Range loss rate in the next 5 years (percentage)" , "WTP (*1000 USD) for Vehicle Attributes" , "dollar" ,
  "range_year0"                , "BEV Electric Range at Year 0 (per 100 miles)" , "WTP (*1000 USD) for Vehicle Attributes" , "dollar" ,
  "degradation"                , "Range loss rate after 8 years (percentage)"   , "WTP (*1000 USD) for Vehicle Attributes" , "dollar" ,
...
gtsave(
  ...
  file = here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_class_profile_summary_cars_suvs_lc_3c_rangeloss.html"
