...
\begin{keywords}
Battery electric vehicle \sep Used vehicle market \sep Discrete choice experiment \sep Willingness to pay \sep Mixed logit \sep Consumer preferences \sep Adoption heterogeneity \sep Driving range
\end{keywords}
...
Four separate DCE designs were constructed, one per combination of body type (car, SUV) and budget tier (low: $\leq$\$20,000, high: $>$\$20,000), so that the price and vehicle attributes presented to each respondent corresponded to a plausible purchase context. 
