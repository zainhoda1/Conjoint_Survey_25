...
car_suv_lc_5c <- read_csv(here(
  ...
  "battery_analysis",
  "apollo",
  "piecewise_rangeloss_car_suv_lc_5c_refurb_treat_1_estimates.csv"
))
...
var_meta <- tribble(
  ...
  "packreplace_treat"   , "Battery Refurbishment: Pack Replace x Info Treatment" , "Vehicle Attributes" , "dollar" ,
  "cellreplace_treat"   , "Battery Refurbishment: Cell Replace x Info Treatment" , "Vehicle Attributes" , "dollar" ,
