...
| ![](images/battery_survey_battery_degradation1.png){fig-align="center" width="300"} | **Electric range -** The maximum distance (in miles) the vehicle can travel on a full battery charge, under typical driving conditions.<br>**Battery Condition -** How much (in percentages) of the battery’s original capacity remains.|
