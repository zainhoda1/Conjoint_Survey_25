...
sd_question(
  ...
  option = c(
    "Small Sedan" = "car_small_1",
    "Mid Sedan" = "car_mid_1",
    "Large Sedan"   = "car_large_1",
    "Small SUV"  = "suv_small_1",
    "Large SUV" = "suv_large_1"
  )
)
...
Your chosen value 1 is, `r sd_output("budget", type = "value")`!

Your chosen value 2 is, `r sd_output("cost_com", type = "value")`!

Multiplied value is, `r sd_output("multiplied_value", type = "value")`

```{r}
budget_value <- sd_output("budget", type = "value")
#print(budget_value)000000000000000000000-
numeric_vector <- as.numeric(unlist(budget_value))
...
![Selected Vehicle Image](https://raw.githubusercontent.com/zainhoda1/testing_surveydown/main/test1/figs/dallE_car_image1.jpg){fig-align="centre"  width=30%}
...
cost1 <- q1_alt1$price * numeric_vector 
#cost2 <- as.numeric(q1_alt2$price) 
#cost3 <- as.numeric(q1_alt3$price) 

names(q1_options)[1] <- glue("**Option 1**<br>
    **Vehicle Type**:  {q1_alt1$powertrain}   
    **Range(in miles)**: {q1_alt1$range} <br>
    **Purchase Price**: {cost1} <br>
...
![Sample Vehicle Image](https://raw.githubusercontent.com/zainhoda1/testing_surveydown/main/test1/figs/dallE_car_image1.jpg){fig-align="centre"  width=30%}
