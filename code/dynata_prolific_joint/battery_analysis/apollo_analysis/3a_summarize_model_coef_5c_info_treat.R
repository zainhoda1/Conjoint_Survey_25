...
car_suv_lc_5c <- read_csv(here(
  "code",
  "output",
  "model_output",
  "battery_analysis",
  "apollo",
  "piecewise_rangeloss_car_suv_lc_5c_info_treat_1_estimates.csv"
))
colnames(car_suv_lc_5c)[1] <- "variable"


# ---- Format combined model coefficients ----
combined_all <- car_suv_lc_5c %>%
...
var_meta <- tribble(
  ...
  "loss_pw1_treat"      , "Range Loss Rate: <12% x Info Treatment"     , "Vehicle Attributes" , "dollar" ,
  "loss_pw2_treat"      , "Range Loss Rate: 12%-24% x Info Treatment"  , "Vehicle Attributes" , "dollar" ,
  "loss_pw3_treat"      , "Range Loss Rate: 24%+ x Info Treatment"     , "Vehicle Attributes" , "dollar" ,
...
write.csv(
  ...
  here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_car_suv_lc_5c_formatted_model_estimates_piecewise_rangeloss_info_treat.csv"
  ),
  row.names = FALSE
)
...
gtsave(
  ...
  file = here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_model_summary_cars_suvs_lc_5c_piecewise_rangeloss_info_treat.html"
  )
)
