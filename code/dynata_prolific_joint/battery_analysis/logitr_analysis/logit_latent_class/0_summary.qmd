...
# Heatmaps
- SUVs consistently show more negative WTP at higher degradation rates. SUVs are heavier and generally less efficient, so the "disutility" (the amount they want discounted) is much higher.
- For SUV users: warranty information sensitivity to degradation risk
- For Car users: Instead of reassuring consumers, providing warranty information likely:
	•	Heighten sensitivity to degradation risk. 
	•	Increases consumers’ awareness of long-term performance risk
	•	Anchors attention on the 70–75% SOH threshold
