...
### Car+SUV
apollo_control = list(
  modelName = paste0("piecewise_rangeloss_car_suv_lc_5c_refurb_treat_", i),
  modelDescr = "LC model with 5 classes, piecewise linear range and range loss, refurbishment x treatment interactions",
  indivID = "respID",
  nCores = 2,
  panelData = TRUE,
...
apollo_beta = c(
  ...
  b_loss_pw2_a = 0,
  b_loss_pw3_a = 0,
  # Refurbishment treatment interactions (Class A)
  b_packreplace_treat_a = 0,
  b_cellreplace_treat_a = 0,
  b_packreplace_a = 0,
  b_cellreplace_a = 0,
  b_price_a = 0,
  ...
  b_loss_pw2_b = 0,
  b_loss_pw3_b = 0,
  # Refurbishment treatment interactions (Class B)
  b_packreplace_treat_b = 0,
  b_cellreplace_treat_b = 0,
  b_packreplace_b = 0,
  b_cellreplace_b = 0,
  b_price_b = 0,
  ...
  b_loss_pw2_c = 0,
  b_loss_pw3_c = 0,
  # Refurbishment treatment interactions (Class C)
  b_packreplace_treat_c = 0,
  b_cellreplace_treat_c = 0,
  b_packreplace_c = 0,
  b_cellreplace_c = 0,
  b_price_c = 0,
  ...
  b_loss_pw2_d = 0,
  b_loss_pw3_d = 0,
  # Refurbishment treatment interactions (Class D)
  b_packreplace_treat_d = 0,
  b_cellreplace_treat_d = 0,
  b_packreplace_d = 0,
  b_cellreplace_d = 0,
  b_price_d = 0,
  ...
  b_loss_pw2_e = 0,
  b_loss_pw3_e = 0,
  # Refurbishment treatment interactions (Class E)
  b_packreplace_treat_e = 0,
  b_cellreplace_treat_e = 0,
  b_packreplace_e = 0,
  b_cellreplace_e = 0,
  b_price_e = 0,
...
apollo_lcPars = function(apollo_beta, apollo_inputs) {
  ...
  lcpars[["b_packreplace_treat"]] = list(
    b_packreplace_treat_a,
    b_packreplace_treat_b,
    b_packreplace_treat_c,
    b_packreplace_treat_d,
    b_packreplace_treat_e
  )
  lcpars[["b_cellreplace_treat"]] = list(
    b_cellreplace_treat_a,
    b_cellreplace_treat_b,
    b_cellreplace_treat_c,
    b_cellreplace_treat_d,
    b_cellreplace_treat_e
  )
...
apollo_probabilities = function(
  ...
  for (s in 1:5) {
    ...
    V[["alt1"]] <-
      ...
      b_packreplace_treat[[s]] *
        battery_info_treat *
        battery_refurbishpackreplace_1 +
      b_cellreplace_treat[[s]] *
        battery_info_treat *
        battery_refurbishcellreplace_1 +
      b_price[[s]] * price_1
    ...
    V[["alt2"]] <-
      ...
      b_packreplace_treat[[s]] *
        battery_info_treat *
        battery_refurbishpackreplace_2 +
      b_cellreplace_treat[[s]] *
        battery_info_treat *
        battery_refurbishcellreplace_2 +
      b_price[[s]] * price_2
    ...
    V[["alt3"]] <-
      ...
      b_packreplace_treat[[s]] *
        battery_info_treat *
        battery_refurbishpackreplace_3 +
      b_cellreplace_treat[[s]] *
        battery_info_treat *
        battery_refurbishcellreplace_3 +
      b_price[[s]] * price_3
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_5c_refurb_treat_apollo_inputs_piecewise_rangeloss.rds"
  )
)
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_5c_refurb_treat_apollo_probabilities_piecewise_rangeloss.rds"
  )
)
