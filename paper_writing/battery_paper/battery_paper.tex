...
\label{section:data}
\subsection{NationwideUsed EV Survey}
...
\begin{figure}[pos=H]
    \centering
    \includegraphics[width=\textwidth]{../../code/output/model_output/battery_analysis/apollo/0_lc6_class_profiles.pdf}
