...
var_meta <- tribble(
  ...
  "powertrainbev"          , "Powertrain: BEV"                      , "Vehicle Attributes" , "dollar" ,
  "powertrainhev"          , "Powertrain: HEV"                      , "Vehicle Attributes" , "dollar" ,
  "range_bev"              , "BEV Electric Range (100 miles)"       , "Vehicle Attributes" , "dollar" ,
  "mileage"                , "Mileage (10,000 miles)"               , "Vehicle Attributes" , "dollar" ,
  "age"                    , "Vehicle Age (year)"                   , "Vehicle Attributes" , "dollar" ,
  "operating_cost"         , "Operating Cost (cent/mile)"           , "Vehicle Attributes" , "dollar" ,
  ...
  "evenvironment_positive" , "EV Battery Environmentally Positive"  , "Active Indicators"  , "number" ,
  "evfunction_negative"    , "EV Battery Functionally Negative"     , "Active Indicators"  , "number" ,
  # "budget"                 , "Budget for next vehicle (10,000 USD)" , "Active Indicators"  , "number" ,
  ...
  "risk_taking"            , "Risk Taking"                          , "Active Indicators"  , "number" ,
  "price_sensitivity"      , "Price Sensitivity"                    , "Active Indicators"  , "number"
)
...
gt_car_suv_lc_3c <- gt_formatted |>
  ...
  tab_header(
    title = md(
      "**Used Vehicle Valuation: Model Results (Car vs SUV)**"
    ),
    subtitle = "Est. (SE)[Sig.] for each class and segment. Significance: *** p<0.001, ** p<0.01, * p<0.05, . p<0.1." # Add significance legend to subtitle
  ) %>%
  tab_options(
...
gtsave(
  ...
  file = here::here(
    ...
    "vehicle_analysis",
    "apollo",
    "0_model_summary_cars_suvs_combined_lc_3c.html"
  )
)
