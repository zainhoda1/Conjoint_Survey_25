...
sd_question(
  type   = 'mc_buttons',
  id     = 'next_veh_fuel_new_phev',
  label  = "**How likely are you to purchase a 'New plug-in hybrid electric vehicle' as your next vehicle?**",
  option = c(
    "Very unlikely" = "very_unlikely",
    "Somewhat unlikely" = "somewhat_unlikely",
    "Neither likely nor unlikely" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'next_veh_fuel_used_phev',
  label  = "**How likely are you to purchase a 'Used plug-in hybrid electric vehicle' as your next vehicle?**",
  option = c(
    "Very unlikely" = "very_unlikely",
    "Somewhat unlikely" = "somewhat_unlikely",
    "Neither likely nor unlikely" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'next_veh_fuel_new_bev',
  label  = "**How likely are you to purchase a 'New battery electric vehicle' as your next vehicle?**",
  option = c(
    "Very unlikely" = "very_unlikely",
    "Somewhat unlikely" = "somewhat_unlikely",
    "Neither likely nor unlikely" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'next_veh_fuel_used_bev',
  label  = "**How likely are you to purchase a 'Used battery electric vehicle' as your next vehicle?**",
  option = c(
    "Very unlikely" = "very_unlikely",
    "Somewhat unlikely" = "somewhat_unlikely",
    "Neither likely nor unlikely" = "neutral",
...
```{r}
sd_output("make_table_short_battery")
```
...
sd_question(
  type   = 'mc_buttons',
  id     = 'battery_attribute_veh_mile',
  label  = "**How important is 'Vehicle mileage' to you when selecting a used battery electric vehicle?**",
  option = c(
    "Unimportant" = "unimportant",
    "Of little importance" = "little_important",
    "Moderately important" = "moderately_important",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'battery_attribute_purchase_price',
  label  = "**How important is 'Purchase price' to you when selecting a used battery electric vehicle?**",
  option = c(
    "Unimportant" = "unimportant",
    "Of little importance" = "little_important",
    "Moderately important" = "moderately_important",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'battery_attribute_battery_refurbish',
  label  = "**How important is 'Battery refurbishment history' to you when selecting a used battery electric vehicle?**",
  option = c(
    "Unimportant" = "unimportant",
    "Of little importance" = "little_important",
    "Moderately important" = "moderately_important",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'battery_attribute_veh_range',
  label  = "**How important is 'Vehicle range' to you when selecting a used battery electric vehicle?**",
  option = c(
    "Unimportant" = "unimportant",
    "Of little importance" = "little_important",
    "Moderately important" = "moderately_important",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'battery_attribute_battery_health',
  label  = "**How important is 'Battery health' to you when selecting a used battery electric vehicle?**",
  option = c(
    "Unimportant" = "unimportant",
    "Of little importance" = "little_important",
    "Moderately important" = "moderately_important",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_1_a_ev_norm',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'People who are important to me think that I should buy an EV.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_1_a_ev_cost',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'Driving an EV would eventually result in cost savings.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_1_a_ev_environment',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'Driving an EV would be beneficial to the environment in the long term.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_1_b_ev_range',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'If I owned a BEV, I would often worry about running out of charge.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_1_b_ev_resale',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'BEVs are less valuable than gasoline cars on the resale market, because the technology is always advancing.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_1_b_ev_price',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'The price of an EV is too high'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_2_a_ev_battery_environment',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'Purchasing refurbished EV batteries will minimize negative effects on natural ecosystems.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_2_a_ev_battery_function',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'Refurbished EV batteries do NOT perform and function as original EV batteries.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_2_a_attention_check_agree',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'Please select \"Strongly agree\" as your response to this item.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_2_b_price_sensitive',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'Generally, I am willing to put in extra effort to find lower prices.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_2_b_tech_savvy',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'I like to be among the first people to have the latest technology.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
sd_question(
  type   = 'mc_buttons',
  id     = 'attitudes_2_b_risk_taker',
  label  = "**Please indicate the extent to which you agree or disagree with the following statement - 'I am a person who is fully prepared to take risks.'**",
  option = c(
    "Strongly disagree" = "strongly_disagree",
    "Somewhat disagree" = "somewhat_disagree",
    "Neither agree nor disagree" = "neutral",
...
### The survey completion code is `r sd_output("completion_code", type = 'value')`. Please share this code to collect your candy from our table.
...
```{r}
sd_nav(label_next = 'next', show_next = FALSE)
```
