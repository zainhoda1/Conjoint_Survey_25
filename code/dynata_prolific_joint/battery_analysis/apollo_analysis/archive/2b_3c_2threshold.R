...
### Car+SUV
apollo_control = list(
  modelName = paste0("piecewise2t_rangeloss_car_suv_lc_3c_", i),
  modelDescr = "LC model with 3 classes, 2-threshold piecewise range and range loss",
  indivID = "respID",
  nCores = 2,
  panelData = TRUE,
  outputDirectory = paste0(
...
apollo_beta = c(
  ...
  b_no_choice_a = 0,
  b_mileage_a = 0,
  # Range (year 3) piecewise slopes: <150 mi | 150+ mi
  b_range_pw1_a = 0,
  b_range_pw2_a = 0,
  # Range loss piecewise slopes: <20% | 20%+
  b_loss_pw1_a = 0,
  b_loss_pw2_a = 0,
  b_packreplace_a = 0,
  b_cellreplace_a = 0,
...
apollo_lcPars = function(apollo_beta, apollo_inputs) {
  ...
  lcpars[["b_range_pw1"]] = list(b_range_pw1_a, b_range_pw1_b, b_range_pw1_c)
  lcpars[["b_range_pw2"]] = list(b_range_pw2_a, b_range_pw2_b, b_range_pw2_c)
  lcpars[["b_loss_pw1"]] = list(b_loss_pw1_a, b_loss_pw1_b, b_loss_pw1_c)
  lcpars[["b_loss_pw2"]] = list(b_loss_pw2_a, b_loss_pw2_b, b_loss_pw2_c)
...
apollo_probabilities = function(
  ...
  for (s in 1:3) {
    ...
    V[["alt1"]] <-
      b_mileage[[s]] *
      mileage_1 +
      b_range_pw1[[s]] * pmin(battery_range_year3_1, 1.50) +
      b_range_pw2[[s]] * pmax(0, battery_range_year3_1 - 1.50) +
      b_loss_pw1[[s]] * pmin(battery_range_loss_1, 20) +
      b_loss_pw2[[s]] * pmax(0, battery_range_loss_1 - 20) +
    ...
    V[["alt2"]] <-
      b_mileage[[s]] *
      mileage_2 +
      b_range_pw1[[s]] * pmin(battery_range_year3_2, 1.50) +
      b_range_pw2[[s]] * pmax(0, battery_range_year3_2 - 1.50) +
      b_loss_pw1[[s]] * pmin(battery_range_loss_2, 20) +
      b_loss_pw2[[s]] * pmax(0, battery_range_loss_2 - 20) +
    ...
    V[["alt3"]] <-
      b_mileage[[s]] *
      mileage_3 +
      b_range_pw1[[s]] * pmin(battery_range_year3_3, 1.50) +
      b_range_pw2[[s]] * pmax(0, battery_range_year3_3 - 1.50) +
      b_loss_pw1[[s]] * pmin(battery_range_loss_3, 20) +
      b_loss_pw2[[s]] * pmax(0, battery_range_loss_3 - 20) +
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_3c_apollo_inputs_piecewise2threshold_rangeloss.rds"
  )
)
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_3c_apollo_probabilities_piecewise2threshold_rangeloss.rds"
  )
)
