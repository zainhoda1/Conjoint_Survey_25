...
\section{Method:Latent Class Choice Model (LCCM)}

\noindent $\bullet$ \textbf{Model Framework} \par
...
\noindent $\bullet$ \textbf{Class-specific Choice Model}\par
...
\noindent $\bullet$ \textbf{Class Membership Model} \par
...
\noindent $\bullet$ \textbf{Willingness to Pay} \par
