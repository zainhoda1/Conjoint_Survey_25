...
car_suv_lc_5c <- read_csv(here(
  ...
  "battery_analysis",
  "apollo",
  "piecewise_rangeloss_car_suv_lc_5c_1_estimates.csv"
))
...
gtsave(
  ...
  file = here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_model_summary_cars_suvs_lc_5c_piecewise_rangeloss.html"
  )
)

gt_car_suv_lc_5c_latex <- gt_car_suv_lc_5c %>%
  tab_options(
...
writeLines(
  ...
  con = here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_class_profile_summary_cars_suvs_lc_5c.tex"
  )
)
