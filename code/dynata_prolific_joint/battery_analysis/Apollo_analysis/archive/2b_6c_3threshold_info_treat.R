...
### Car+SUV
apollo_control = list(
  modelName = paste0("info_treat_piecewise_rangeloss_car_suv_lc_6c_", i),
...
apollo_beta = apollo_readBeta(
  apollo_beta,
  apollo_fixed,
  "info_treat_piecewise_rangeloss_car_suv_lc_6c_1",
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_6c_apollo_inputs_piecewise_rangeloss_info_treat.rds"
  )
)
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_6c_apollo_probabilities_piecewise_rangeloss_info_treat.rds"
  )
)
