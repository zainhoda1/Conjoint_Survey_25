...
sd_question(
  type  = 'slider',
  id    = 'gas_mileage1',
  label = "What gas mileage does your vehicle give? (Miles per gallon) ",
  option = c(
    "0 " = "0",
    "10" = "10",
    "20" = "20",
...
::: {#cbc_intro .sd-page}
## Section 3 of 5 
## Choice Question Introduction



We will now show you **six** choice questions starting on the next page. Below is an example of the type of questions you will be asked.
