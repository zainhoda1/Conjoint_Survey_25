...
apollo_control = list(
  modelName       = paste0("piecewise_rangeloss_car_suv_lc_3c_", i),
  modelDescr      = "LC model with 3 classes, piecewise linear range and range loss",
  indivID         = "respID",
  nCores          = 2,
  panelData       = TRUE,
...
apollo_beta = c(
  ...
  # Class C is the reference (fixed to 0)
  delta_a                    = 0,
...
### Class C is the reference class: fix all its allocation parameters to 0
apollo_fixed = c(
  "delta_c",
  "gamma_EV_rangeanxiety_c",
  "gamma_risktaker_c",
  "gamma_hhincome_c",
  "gamma_ev_charge_c",
  "gamma_knowledge_ev_c",
  "gamma_evb_environment_agree_c",
  "gamma_evb_function_disagree_c",
  "gamma_hhveh_fuel_c",
  "gamma_veh_range_c",
  "gamma_suv_c"
)
...
apollo_beta = apollo_readBeta(
  ...
  "piecewise_rangeloss_car_suv_lc_3c_1", overwriteFixed = FALSE
)
...
apollo_lcPars = function(apollo_beta, apollo_inputs) {
  ...
  lcpars[["b_range_pw3"]]   = list(b_range_pw3_a,   b_range_pw3_b,   b_range_pw3_c)
  ...
  lcpars[["b_loss_pw3"]]    = list(b_loss_pw3_a,    b_loss_pw3_b,    b_loss_pw3_c)
  lcpars[["b_packreplace"]] = list(b_packreplace_a, b_packreplace_b, b_packreplace_c)
  lcpars[["b_cellreplace"]] = list(b_cellreplace_a, b_cellreplace_b, b_cellreplace_c)
