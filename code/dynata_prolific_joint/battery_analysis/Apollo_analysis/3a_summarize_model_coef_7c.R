...
colnames(car_suv_lc_7c)[1] <- "variable"
...
write.csv(
  ...
  here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_car_suv_lc_7c_formatted_model_estimates_piecewise_rangeloss.csv"
  ),
  row.names = FALSE
)
...
gtsave(
  ...
  file = here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_model_summary_cars_suvs_lc_7c_piecewise_rangeloss.html"
  )
)

gt_car_suv_lc_7c_latex <- gt_car_suv_lc_7c %>%
  tab_options(
...
writeLines(
  ...
  con = here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_class_profile_summary_cars_suvs_lc_7c.tex"
  )
)
