...
colnames(car_suv_lc_6c)[1] <- "variable"
...
write.csv(
  ...
  here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_car_suv_lc_6c_formatted_model_estimates_piecewise_rangeloss_removebadcase.csv"
  ),
  row.names = FALSE
)
...
gtsave(
  ...
  file = here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_model_summary_cars_suvs_lc_6c_piecewise_rangeloss_removebadcase.html"
  )
)
