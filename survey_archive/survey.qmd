...
## Below are some questions about the household vehicle you currently drive most often.
...
sd_question(
  type  = 'mc',
  id    = 'primary_veh_cost',
  label = "**To your best estimate, what was the total purchase or lease price for this vehicle?** *Please **include** all related expenses (such as down payment, monthly payments, taxes, fees, etc.), but **do not include** any trade-in value or credits from selling another vehicle.*",
  option = c(
    "$4,999 or less" = "2500",
    "$5,000 - $9,999" = "7500",
    "$10,000 - $14,999" = "12000",
...
sd_question(
  ...
  label = "**How many miles can this vehicle travel on a full tank or full charge?**",
  option = c(
    "49 miles or less" = "25",
    "50 - 99 miles" = "75" , 
    "100 - 149 miles" = "125",
...
sd_question(
  ...
  row = c(
    "New plug-in hybrid vehicle"     = "new_phev",
    "Used plug-in hybrid vehicle"    = "used_phev",
  ...
  option = c(
    ...
    "Neither likely nor unlikely"  = "nuetral",
...
sd_question(
  ...
  label = "**How important are the following attributes to you when selecting a battery electric vehicle?**",
  row = c(
    "Vehicle mileage" = "veh_mile",
    "Vehicle price"     = "veh_price",
...
sd_question(
  type  = 'mc_multiple',
  id    = 'race',
  label = "**Which race/ethnicity best describes you?** *Select all that apply.*",
  option = c(
...
sd_question(
  ...
  label  = "**Which of the following categories best describes your current employment status?** *Select all that apply.*",
  option = c(
...
sd_question(
  ...
  option = c(
    ...
    "$150,000 - $174,999"  = "175000",
    "$175,000 - $199,999" = "200000",
...
Sorry, but you are not qualified to take our survey. We appreciate your time and participation.
