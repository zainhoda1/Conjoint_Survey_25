...
### Car+SUV
apollo_control = list(
  modelName = paste0("piecewise_rangeloss_car_suv_lc_5c_info_treat_", i),
...
apollo_beta = c(
  ...
  b_loss_pw2_a = 0,
  b_loss_pw3_a = 0,
  # Range loss treatment interactions (Class A)
  b_loss_pw1_treat_a = 0,
  b_loss_pw2_treat_a = 0,
  b_loss_pw3_treat_a = 0,
  b_packreplace_a = 0,
  b_cellreplace_a = 0,
  b_price_a = 0,
  ...
  b_loss_pw2_b = 0,
  b_loss_pw3_b = 0,
  # Range loss treatment interactions (Class B)
  b_loss_pw1_treat_b = 0,
  b_loss_pw2_treat_b = 0,
  b_loss_pw3_treat_b = 0,
  b_packreplace_b = 0,
  b_cellreplace_b = 0,
  b_price_b = 0,
  ...
  b_loss_pw2_c = 0,
  b_loss_pw3_c = 0,
  # Range loss treatment interactions (Class C)
  b_loss_pw1_treat_c = 0,
  b_loss_pw2_treat_c = 0,
  b_loss_pw3_treat_c = 0,
  b_packreplace_c = 0,
  b_cellreplace_c = 0,
  b_price_c = 0,
  ...
  b_loss_pw2_d = 0,
  b_loss_pw3_d = 0,
  # Range loss treatment interactions (Class D)
  b_loss_pw1_treat_d = 0,
  b_loss_pw2_treat_d = 0,
  b_loss_pw3_treat_d = 0,
  b_packreplace_d = 0,
  b_cellreplace_d = 0,
  b_price_d = 0,
  ...
  b_loss_pw2_e = 0,
  b_loss_pw3_e = 0,
  # Range loss treatment interactions (Class E)
  b_loss_pw1_treat_e = 0,
  b_loss_pw2_treat_e = 0,
  b_loss_pw3_treat_e = 0,
  b_packreplace_e = 0,
  b_cellreplace_e = 0,
  b_price_e = 0,
...
apollo_probabilities = function(
  ...
  for (s in 1:5) {
    ...
    V[["alt1"]] <-
      ...
      b_loss_pw1_treat[[s]] *
        battery_info_treat *
        pmin(battery_range_loss_1, 12) +
      b_loss_pw2_treat[[s]] *
        battery_info_treat *
        pmax(0, pmin(battery_range_loss_1, 24) - 12) +
      b_loss_pw3_treat[[s]] *
        battery_info_treat *
        pmax(0, battery_range_loss_1 - 24) +
    ...
    V[["alt2"]] <-
      ...
      b_loss_pw1_treat[[s]] *
        battery_info_treat *
        pmin(battery_range_loss_2, 12) +
      b_loss_pw2_treat[[s]] *
        battery_info_treat *
        pmax(0, pmin(battery_range_loss_2, 24) - 12) +
      b_loss_pw3_treat[[s]] *
        battery_info_treat *
        pmax(0, battery_range_loss_2 - 24) +
    ...
    V[["alt3"]] <-
      ...
      b_loss_pw1_treat[[s]] *
        battery_info_treat *
        pmin(battery_range_loss_3, 12) +
      b_loss_pw2_treat[[s]] *
        battery_info_treat *
        pmax(0, pmin(battery_range_loss_3, 24) - 12) +
      b_loss_pw3_treat[[s]] *
        battery_info_treat *
        pmax(0, battery_range_loss_3 - 24) +
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_5c_info_treat_apollo_inputs_piecewise_rangeloss.rds"
  )
)
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_5c_info_treat_apollo_probabilities_piecewise_rangeloss.rds"
  )
)
