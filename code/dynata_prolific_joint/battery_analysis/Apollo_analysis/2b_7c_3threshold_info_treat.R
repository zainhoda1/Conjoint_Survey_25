...
### Car+SUV
apollo_control = list(
  modelName = paste0("info_treat_piecewise_rangeloss_car_suv_lc_7c_", i),
  modelDescr = "LC model with 7 classes, piecewise linear range and range loss",
  indivID = "respID",
  nCores = 6,
  panelData = TRUE,
...
apollo_beta = c(
  ...
  # Class G is the reference (fixed to 0)
  delta_a = 0,
  ...
  gamma_veh_range_g = 0,
  gamma_suv_g = 0,
  gamma_info_treat_g = 0
)

### Class G is the reference class: fix all its allocation parameters to 0
apollo_fixed = c(
  "delta_g",
  "gamma_EV_rangeanxiety_g",
  "gamma_risktaker_g",
  "gamma_hhincome_g",
  "gamma_ev_charge_g",
  # "gamma_ev_neighbor_g",
  "gamma_knowledge_ev_g",
  "gamma_evb_environment_agree_g",
  "gamma_evb_function_disagree_g",
  "gamma_hhveh_fuel_g",
  # "gamma_veh_refuel_g",
  "gamma_veh_range_g",
  "gamma_suv_g",
...
apollo_beta = apollo_readBeta(
  apollo_beta,
  apollo_fixed,
  "info_treat_piecewise_rangeloss_car_suv_lc_7c_1",
...
apollo_lcPars = function(apollo_beta, apollo_inputs) {
  ...
  V[["class_f"]] = delta_f +
    ...
    gamma_info_treat_f * battery_info_treat
  ...
  V[["class_g"]] = delta_g +
    ...
    gamma_info_treat_g * battery_info_treat
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_7c_apollo_inputs_piecewise_rangeloss_info_treat.rds"
  )
)
...
saveRDS(
  ...
  file = here(
    ...
    "battery_analysis",
    "apollo",
    "car_suv_lc_7c_apollo_probabilities_piecewise_rangeloss_info_treat.rds"
  )
)
