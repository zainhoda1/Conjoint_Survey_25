...
\textbf{Class 1: Opt-Out Dominant, BEV-Skeptical (8.7\%, $n$=252).}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textheight, height=\textwidth, keepaspectratio]{../../code/output/model_output/battery_analysis/apollo/0_lc6_class_profiles_no_optout.png}
