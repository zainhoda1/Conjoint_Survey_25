...
## Future vehicle section continued!
...
|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Gasoline                | Gasoline vehicles use an internal combustion engine (ICE) that burns gasoline (petrol) to create power.                                                                                                                             |
| Hybrid (HEVs)          | HEVs take net propulsion energy from gasoline but utilize a small battery pack and electric motor to improve fuel efficiency, mostly through regenerative braking, engine downsizing, engine shutoff at idle, and power management. |
| Plug-in Hybrid (PHEVs) | PHEVs are similar to HEVs, except they typically have a larger battery pack that can be charged by plugging into an electrical outlet.                                                                                              |
| Electric (BEV)         | BEVs run purely on electricity and do not use gasoline                                                                                                                                                                              |


| **Types of Powertrain** | **Definition**                                                                                                         |
|-------------------------|------------------------------------------------------------------------------------------------------------------------|
| Gasoline                | A conventional gasoline vehicle uses only gasoline.                                                                    |
| Hybrid (HEVs)           | A hybrid vehicle uses a small battery to reduce fuel use but cannot be plugged in to rechage as it uses only gasoline. |
...
sd_question(
  ...
  label = "Can you name the make and model of atleast one vehicle powered partially or completely by electricity?",
  option = c(
    "Yes" = "Yes",
    "No"  = "No"
  )
...
sd_question(
  ...
  label = "Please name a **make** and **model** of a vehicle that is powered partially or completelyby electricity"
)
