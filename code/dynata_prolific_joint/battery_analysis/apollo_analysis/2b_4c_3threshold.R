...
### Car+SUV
apollo_control = list(
  modelName = paste0("piecewise_rangeloss_car_suv_lc_4c_", i),
  modelDescr = "LC model with 4 classes, piecewise linear range and range loss",
  indivID = "respID",
  nCores = 2,
  panelData = TRUE,
...
apollo_beta = c(
  ...
  # Class D is the reference (fixed to 0)
  delta_a = 0,
...
### Class D is the reference class: fix all its allocation parameters to 0
apollo_fixed = c(
  "delta_d",
  "gamma_EV_rangeanxiety_d",
  "gamma_risktaker_d",
  "gamma_hhincome_d",
  "gamma_ev_charge_d",
  # "gamma_ev_neighbor_d",
  "gamma_knowledge_ev_d",
  "gamma_evb_environment_agree_d",
  "gamma_evb_function_disagree_d",
  "gamma_hhveh_fuel_d",
  # "gamma_veh_refuel_d",
  "gamma_veh_range_d",
  "gamma_suv_d"
...
apollo_lcPars = function(apollo_beta, apollo_inputs) {
  lcpars = list()
  lcpars[["b_no_choice"]] = list(b_no_choice_a, b_no_choice_b, b_no_choice_c, b_no_choice_d)
  lcpars[["b_mileage"]]   = list(b_mileage_a,   b_mileage_b,   b_mileage_c,   b_mileage_d)
  lcpars[["b_range_pw1"]] = list(b_range_pw1_a, b_range_pw1_b, b_range_pw1_c, b_range_pw1_d)
  lcpars[["b_range_pw2"]] = list(b_range_pw2_a, b_range_pw2_b, b_range_pw2_c, b_range_pw2_d)
  lcpars[["b_range_pw3"]] = list(b_range_pw3_a, b_range_pw3_b, b_range_pw3_c, b_range_pw3_d)
  lcpars[["b_loss_pw1"]]  = list(b_loss_pw1_a,  b_loss_pw1_b,  b_loss_pw1_c,  b_loss_pw1_d)
  lcpars[["b_loss_pw2"]]  = list(b_loss_pw2_a,  b_loss_pw2_b,  b_loss_pw2_c,  b_loss_pw2_d)
  lcpars[["b_loss_pw3"]]  = list(b_loss_pw3_a,  b_loss_pw3_b,  b_loss_pw3_c,  b_loss_pw3_d)
  lcpars[["b_packreplace"]] = list(
    b_packreplace_a, b_packreplace_b, b_packreplace_c, b_packreplace_d
  )
  lcpars[["b_cellreplace"]] = list(
    b_cellreplace_a, b_cellreplace_b, b_cellreplace_c, b_cellreplace_d
  )
