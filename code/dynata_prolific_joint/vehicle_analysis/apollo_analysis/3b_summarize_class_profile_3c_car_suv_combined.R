...
var_meta <- tribble(
  ...
  "range_bev"                  , "BEV Electric Range (100 miles)"                , "WTP (1000 USD) for Vehicle Attributes"       , "dollar" ,
  "mileage"                    , "Mileage (10,000 miles)"                        , "WTP (1000 USD) for Vehicle Attributes"       , "dollar" ,
  "age"                        , "Vehicle Age (year)"                            , "WTP (1000 USD) for Vehicle Attributes"       , "dollar" ,
  "operating_cost"             , "Operating Cost (cent/mile)"                    , "WTP (1000 USD) for Vehicle Attributes"       , "dollar" ,
