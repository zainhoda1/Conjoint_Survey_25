...
### CAR
apollo_control = list(
  modelName = paste0("rangeloss_car_lc_3c_", i),
...
# ### SUV
# apollo_control = list(
#   modelName = paste0("rangeloss_suv_lc_3c_", i),
#   modelDescr = "LC model with 3 classes with indicator",
#   indivID = "respID",
#   nCores = 2,
#   panelData = TRUE,
...
### Car+SUV
# apollo_control = list(
#   modelName = paste0("rangeloss_car_suv_lc_3c_", i),
#   modelDescr = "LC model with 3 classes with indicator",
#   indivID = "respID",
#   nCores = 2,
#   panelData = TRUE,
...
apollo_probabilities = function(
  ...
  for (s in 1:3) {
    ...
    V[["alt1"]] <-
      b_mileage[[s]] *
      mileage_1 +
      b_range_year0[[s]] * battery_range_year3_1 +
    ...
    V[["alt2"]] <-
      b_mileage[[s]] *
      mileage_2 +
      b_range_year0[[s]] * battery_range_year3_2 +
    ...
    V[["alt3"]] <-
      b_mileage[[s]] *
      mileage_3 +
      b_range_year0[[s]] * battery_range_year3_3 +
...
#     "battery_analysis",
#     "apollo",
#     "suv_lc_3c_apollo_probabilities_rangeloss.rds"
#   )
# )
