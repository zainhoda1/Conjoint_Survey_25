...
\begin{figure}[pos=H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/dumbbell_plots/facet_wtp_budget_range300.png}
    \caption{Modelled WTP for used BEVs by budget tier and vehicle type, driving range fixed at 300 miles. Y-axis shows budget tier (low vs.\ high); vehicle age shown by color; facets show car and SUV segments. Points show mean estimates; horizontal bars show 95\% simulation confidence intervals.}
    \label{fig:wtp_budget_range300_facet}
\end{figure}
...
\begin{figure}[pos=H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/dumbbell_plots/facet_wtp_adopter_age2.png}
    \caption{Modelled WTP for used BEVs by adoption preference and vehicle type, vehicle age fixed at 2 years. Y-axis shows adoption group (likely vs.\ unlikely); driving range shown by color; facets show car and SUV segments. Points show mean estimates; horizontal bars show 95\% simulation confidence intervals.}
    \label{fig:wtp_adopter_age2_facet}
\end{figure}
...
\begin{figure}[pos=H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/dumbbell_plots/facet_wtp_adopters_range300.png}
    \caption{Modelled WTP for used BEVs by adoption preference and vehicle type, driving range fixed at 300 miles. Y-axis shows adoption group (likely vs.\ unlikely); vehicle age shown by color; facets show car and SUV segments. Points show mean estimates; horizontal bars show 95\% simulation confidence intervals.}
    \label{fig:wtp_adopter_range300_facet}
\end{figure}
