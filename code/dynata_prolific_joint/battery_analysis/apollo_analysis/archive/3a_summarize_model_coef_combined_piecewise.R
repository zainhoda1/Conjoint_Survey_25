...
var_meta <- tribble(
  ...
  "range_pw1"           , "BEV Electric Range (Year 3): 40-130 miles"  , "Vehicle Attributes" , "dollar" ,
  ...
  "loss_pw1"            , "Range Loss Rate: 5-12%"                     , "Vehicle Attributes" , "dollar" ,
...
gtsave(
  ...
  file = here::here(
    ...
    "battery_analysis",
    "apollo",
    "0_model_summary_cars_suvs_lc_3c_piecewise_rangeloss.html"
  )
)
